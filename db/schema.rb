...
ActiveRecord::Schema.define(version: 2020_02_18_143539) do
  ...
  create_table "added_items", force: :cascade do |t|
    ...
    t.integer "quantity"
    t.index ["basket_id"], name: "index_added_items_on_basket_id"
    t.index ["item_id"], name: "index_added_items_on_item_id"
    t.index ["user_id"], name: "index_added_items_on_user_id"
  end

  create_table "basket_members", force: :cascade do |t|
    t.bigint "user_id"
    t.bigint "basket_id"
    t.datetime "created_at", default: -> { "now()" }, null: false
    t.datetime "updated_at", default: -> { "now()" }, null: false
    t.index ["basket_id"], name: "index_basket_members_on_basket_id"
    t.index ["user_id"], name: "index_basket_members_on_user_id"
  end
